...
class StaffDashboard(QWidget):
    def __init__(self, login_widget, username, conn):
        ...
        self.history_btn = CustomButton("History", self.buttonPanel,
                                        "rgb(60, 146, 193)", "cyan", "cyan", self.button_group)
    ...
    def stock_in(self):
        ...
        dialog.setStyleSheet("""
            ...
            QLineEdit { background-color: white; border-radius: 6px; padding: 4px; font-size: 13px; }
            QPushButton { background-color: rgb(50,150,200); color: white; font-weight: bold; border-radius: 6px; padding: 6px; }
            QPushButton:hover { background-color: rgb(70,170,220); }
            QPushButton:pressed { background-color: rgb(30,130,180); }
            QTableWidget { background-color: #f8f9fa; alternate-background-color: #e9ecef; gridline-color: #b0b0b0; border-radius: 6px; font-size: 13px; }
        """)
        ...
        def confirm_stock_in():
            ...
            try:
                ...
                QMessageBox.information(dialog, "Success",
                                        f"Stock updated for ProductID {product_id}!\nNew quantity: {new_qty}")
    ...
    def stock_out(self):
        ...
        def confirm_stock_out():
            ...
            try:
                ...
                msg.setStyleSheet("""
                    QMessageBox { background-color: rgb(70, 70, 70); color: white; font-size: 14px; font-weight: bold; }
